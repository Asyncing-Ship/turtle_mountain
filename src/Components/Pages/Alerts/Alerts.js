...
class Alerts extends Component {
  ...
  render() {
    //this page displays all alerts to a user. They will get notifications when someone responds or tags you in a post or question
    return (
      <>
            ...
            >
              ...
              <Flex>
                {x.is_admin ? (
                  ...
                  <Tag rounded="full" size="sm" variantColor="yellow" mx={2}>
                    <TagLabel>
                      {x.first_name} {x.last_name}
                    </TagLabel>
                  </Tag>
